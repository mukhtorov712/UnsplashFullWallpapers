...
class PhotoDataSource(private val topicId: String, private val order_by: String) : PagingSource<Int, ImageModel>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ImageModel> {
        try {
            ...
            if (params.key ?: 1 >= 1) {
                photoRepository.getPhoto(topicId, currentPage, order_by)
                    .catch {
